<template>
  <div>
    ...
    <s-form v-if="currentTab === 'add'" :formId="id" :type="type" @edit="edit" :ZZLXTYPE="ZZLXTYPE" :ROLES="ROLES"/>
  </div>
</template>
...
import { MODEL_SYSTEM_DICTIONARY,MODEL_SYSTEM  } from "@/store/mutation-types";
